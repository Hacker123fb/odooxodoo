    ...
    <div className="bg-white dark:bg-[#111827] border border-slate-200/90 dark:border-slate-800 p-8 sm:p-10 rounded-xl shadow-sm w-full">
      ...
      <FormWrapper onSubmit={handleSubmit(onSubmit)} error={formError}>
        ...
        <div className="flex flex-col gap-1 w-full">
          <label htmlFor="roleName" className="text-xs font-semibold text-slate-700 dark:text-slate-300 flex items-center gap-1.5">
            <FiSliders className="w-3.5 h-3.5 text-slate-400" /> Account Role *
          </label>
          <select
            id="roleName"
            className={`w-full py-2 px-3 text-sm bg-white dark:bg-[#0E1422] border rounded-lg outline-none transition-all text-slate-900 dark:text-slate-100 ${
              errors.roleName
        ...
        <div className="text-center mt-4 border-t border-slate-100 dark:border-slate-800 pt-4">
          <p className="text-xs text-slate-500 dark:text-slate-400">
            ...
            <button
              ...
              className="text-slate-900 dark:text-white font-bold underline underline-offset-2 hover:opacity-80 focus:outline-none"
            >
              Sign In instead
            </button>
          </p>
